const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-CNX5RlD2.js","assets/index-Dw0Nh97a.js","assets/index-CEbEv4QQ.css"])))=>i.map(i=>d[i]);
import{_ as x}from"./index-Dw0Nh97a.js";function w(){const t=document.createElement("div");t.className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",t.innerHTML=`
