const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-K0htHSuF.js","assets/main-B47QcL0X.js","assets/main-CEbEv4QQ.css"])))=>i.map(i=>d[i]);
import{_ as x}from"./main-B47QcL0X.js";function w(){const t=document.createElement("div");t.className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",t.innerHTML=`
