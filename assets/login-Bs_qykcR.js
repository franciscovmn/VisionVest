const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/register-DJw0a-bb.js","assets/index-X0HiA2OW.js","assets/index-CEbEv4QQ.css"])))=>i.map(i=>d[i]);
import{_ as a}from"./index-X0HiA2OW.js";function l(){const e=document.createElement("div");e.className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",e.innerHTML=`
