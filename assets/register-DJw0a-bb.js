const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-Bs_qykcR.js","assets/index-X0HiA2OW.js","assets/index-CEbEv4QQ.css"])))=>i.map(i=>d[i]);
import{_ as x}from"./index-X0HiA2OW.js";function w(){const t=document.createElement("div");t.className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",t.innerHTML=`
