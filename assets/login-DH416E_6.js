const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/register-B_UUJw5b.js","assets/main-TjdeWMdC.js","assets/main-CEbEv4QQ.css"])))=>i.map(i=>d[i]);
import{_ as a}from"./main-TjdeWMdC.js";function l(){const e=document.createElement("div");e.className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",e.innerHTML=`
